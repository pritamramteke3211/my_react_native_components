...
const Home = ({navigation}) => {
  ...
  let vidLis = [
    ...
    require('../assets/videos/vid_4.mp4'),
    require('../assets/videos/vid_5.mp4'),
    require('../assets/videos/vid_6.mp4'),
    require('../assets/videos/vid_7.mp4'),
    require('../assets/videos/vid_8.mp4'),
    require('../assets/videos/vid_9.mp4'),
    require('../assets/videos/vid_10.mp4'),
  ];
  ...
  useLayoutEffect(() => {
    ...
    for (const itm of arr) {
      ...
      let itms = lis.splice(0, 5).map((v, indxs) => {
        let obj = {title: v, content: vidLis[indxs]};
        return obj;
      });
