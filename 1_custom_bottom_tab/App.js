...
import { Text, View,StyleSheet,StatusBar, Pressable,LayoutChangeEvent } from 'react-native';
...
const AnimatedTabBar = ({ state: { index: activeIndex, routes }, navigation, descriptors }) => {
  ...
  const xOffset = useDerivedValue(() => {
   ...
   let entr = [...layout].find(({ index }) => index === activeIndex)
...
const TabBarComponent = ({active,onLayout,onPress,options}) => {
 ...
 const  ref  = useRef(null)
  ...
  // animations-----------------------------------------------
  const animationComponentCircleStyles = useAnimatedStyle(()  => {
    return{
      transform: [
        {
  ...
  return (
    <Pressable onPress={onPress} onLayout={onLayout} style={styles.component}>
      <Animated.View style={[styles.componentCircle, animationComponentCircleStyles]} />
